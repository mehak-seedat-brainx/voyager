                        ...
                        <!-- Adding / Editing -->
                            ...
                            <!-- GET THE DISPLAY OPTIONS -->
                                ...
                                @if($row->type == "image")
                                    ...
                                    <img src="@if( !filter_var($dataTypeContent->{$row->field}, FILTER_VALIDATE_URL)){{asset('img/home-icon/reviewerimage/'. $dataTypeContent->{$row->field})  }}@else{{ $dataTypeContent->{$row->field} }}@endif"
